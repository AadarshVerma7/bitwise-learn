...
//     return (
//       <p className="mt-8 text-xl text-neutral-400 h-5">
...
//     return (
//         <div className="bg-bg h-screen w-screen flex">
...
//                 {/* Login Card */}
//                 <div className="relative w-[60%] h-[70%] bg-divBg mt-16 ml-16 rounded-3xl p-8">
